...
NPZ_FILES = [
    "example-chembl28-morgan1024-hash-1k-subsample/_output/ligand__SmilesToLigandFeaturizer__MorganFingerprintFeaturizer_nbits=1024_radius=2__kinase__HashFeaturizer/ChEMBLDatasetProvider/*.npz",
]

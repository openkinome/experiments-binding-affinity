...
PARQUET_FILES = [
    "kinase-informed-smiles-sequence-subsample/_output/ligand__OneHotSMILESFeaturizer__PadFeaturizer_shape=auto__kinase__OneHotEncodedSequenceFeaturizer__PadFeaturizer_shape=auto/ChEMBLDatasetProvider/*.parquet",
]

...
PARQUET_FILES = [
    "kinase-informed-morgan1024-hash-subsample/_output/ligand__MorganFingerprintFeaturizer_nbits=1024_radius=2__kinase__HashFeaturizer/ChEMBLDatasetProvider/*.parquet",
]

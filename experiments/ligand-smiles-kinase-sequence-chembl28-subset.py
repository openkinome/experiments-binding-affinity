...
NPZ_FILES = [
    "example-chembl28-onehotsmiles-sequence-1k-subsample/_output/ligand__SmilesToLigandFeaturizer_style=rdkit__OneHotSMILESFeaturizer__PadFeaturizer_shape=auto__kinase__OneHotEncodedSequenceFeaturizer__PadFeaturizer_shape=auto/ChEMBLDatasetProvider/*.npz",
]

...
PARQUET_FILES = [
    "kinase-informed-morgan1024-composition-subsample/_output/ligand__MorganFingerprintFeaturizer_nbits=1024_radius=2__kinase__AminoAcidCompositionFeaturizer/ChEMBLDatasetProvider/*.parquet",
]
